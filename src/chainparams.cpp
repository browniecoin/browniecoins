...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 420000; // Having every 4 years
        ...
        consensus.nPowTargetTimespan = 5 * 60; // 10 minutes
        ...
        */
        ...
        genesis = CreateGenesisBlock(1317972665, 2084524493, 0x1e0ffff0, 1, 50000 * COIN);
