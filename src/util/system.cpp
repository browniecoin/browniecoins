...
const char * const BITCOIN_CONF_FILENAME = "brownie.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Brownie";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Brownie";
#else
    // Unix
    return pathRet / ".brownie";
#endif
#endif
}
