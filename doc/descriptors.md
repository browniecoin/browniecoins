# Support for Output Descriptors in Brownie Core

Since Brownie Core v0.17, there is support for Output Descriptors. This is a
...
on Brownie's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Brownie Core wallets, a convenience function `combo` is
