...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " brownie-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  brownie-tx [options] <hex-tx> [commands]  Update hex-encoded brownie transaction\n" +
            "or:     brownie-tx [options] -create [commands]   Create hex-encoded brownie transaction\n" +
            "\n";
