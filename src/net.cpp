...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Browniecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"browniecointools.com", "dnsseed.browniecointools.com"},
    {"browniecoinpool.org", "dnsseed.browniecoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"browniecointools.com", "testnet-seed.browniecointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Browniecoin is probably already running."), addrBind.ToString().c_str());
        else
